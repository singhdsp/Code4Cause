      ...
      <div className="w-full h-full shadow-2xl rounded-3xl grid grid-cols-5 bg-white">
        <div className=" col-span-3 flex flex-col justify-center p-16 overflow-y-scroll">
          <div className="space-y-4 flex flex-col justify-center">
            <h1 className="text-center font-bold font-Poppins text-4xl capitalize tracking-wide">
            ...
            <button
              className="w-full py-2 text-white rounded-full uppercase tracking-widest font-bold text-xl bg-gradient-to-br from-violet-600 to-blue-700 transition-all hover:scale-105"
              onClick={() => signInUser()}
            >
              Login
            </button>
        ...
        <div className="col-span-2 relative">
          <img
            src="/bg1.jpg"
            className="h-full w-full overflow-hidden object-cover rounded-e-3xl"
          />
          <div className="absolute top-0 left-0 h-full w-full">
            <div className="flex flex-col justify-center items-center text-white h-full w-full font-Poppins text-center space-y-3 p-8">
              ...
              <h1 className="text-xl font-semibold">
                Sign Up to discover a great ammount of new oppurtunities
              </h1>
              <Link
                to="/SignUp"
                className="px-4 py-2 rounded-full bg-gradient-to-r font-bold uppercase tracking-widest from-violet-800 to-fuchsia-600 hover:scale-110 transition-all"
              >
                Sign Up
              </Link>
            </div>
        ...
        <>
          <div className="absolute top-0 left-0 h-screen w-screen z-10 bg-gray-200 flex justify-center items-center">
            <div className="py-6 pl-10 pr-16 rounded-3xl w-[30rem] shadow-2xl bg-red-600 text-white font-Poppins relative">
              ...
              <div
                className="absolute top-3 right-3 p-2 rounded-full hover:bg-white hover:text-red-600"
